...
export const HALLMARK_CUE =
  /hall\s*m+r?arks?|huid|assaying|\bahc\b|(?<!\d)22\s*k\b|(?<!\d)18\s*k\b|\b916\b|jewell|karigar|gehna|silversmith|(?<!\d)22\s*carat\b|(?<!\d)18\s*carat\b|fineness/i;

export const JEWELLERY_CUE =
  /\b(gold|silver|jewell\w*|gehna|karigar|silversmith|mangalsutra|artefact|(?<!\d)22\s*k\b|(?<!\d)18\s*k\b|916|(?<!\d)22\s*carat\b|(?<!\d)18\s*carat\b|assaying|\bahc\b)\b|सोना|गहना|आभूषण|चांदी/;
